...
ALL_DATA = [   Instrument("138 Student Living Jamaica Limited", "138SL", "JMD", "ORDINARY", "OTHER", None, last_updated=0.0),
    ...
    Instrument("JMMB GROUP 7.00% VR JMD CR PREFERENCE SHARES", "JMMB75NC", "JMD", "PREFERENCE", "FINANCE", None, last_updated=0.0),
    Instrument("JMMB GROUP 7.25% VR JMD CR PREFERENCE SHARES", "JMMB725C", "JMD", "PREFERENCE", "FINANCE", None, last_updated=0.0),
    ...
    Instrument("Derrimon Trading Company Limited 11.75%", "DTL11.75", "JMD", "PREFERENCE", "RETAIL", None, last_updated=0.0),
